...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, train=True,
                 ...
                 download=False,
                 noise_type=None, noise_path = None, is_human=True, noise_mode = 'cifarn', r=0.2):
        ...
        if download:
           self.download()
        self.r = r
        # self.transition = {i: random.randint(0, self.nb_classes - 1) for i in range(self.nb_classes)} # class transition for asymmetric noise
