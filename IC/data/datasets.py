...
from .animal_10N import Animal_10N
...
train_animal_transform = transforms.Compose([
...
test_animal_transform = transforms.Compose([
    # transforms.ToTensor(),
    # transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
])

def input_dataset(dataset, noise_type, noise_path, is_human, noise_mode, r):
    if dataset == 'cifar10':
    ...
    elif dataset == 'animal-10N':
        train_dataset = Animal_10N(mode=0, transform=train_animal_transform)
        test_dataset = Animal_10N(mode=1, transform=test_animal_transform)
        num_classes = 10
        num_training_samples = 50000
